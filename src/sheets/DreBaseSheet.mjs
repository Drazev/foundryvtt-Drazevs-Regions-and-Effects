...
/**
 * A base sheet that provides the necessary services for sheets to interact with the underlying application
 * that will handle rendering. 
 * 
 * Ideally any sheets extending this class should not need to know how to use the framework used for rendering.
 * This sheet should always extend [DocumentSheetV2]{@link https://foundryvtt.com/api/v12/classes/foundry.applications.api.DocumentSheetV2.html}
 */
export default class DreBaseSheet extends HandlebarsApplicationMixin(DocumentSheetV2) {
