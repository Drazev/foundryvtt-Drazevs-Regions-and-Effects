...
var r = (s, t, e) => t in s ? i(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e;
var n = (s, t, e) => r(s, typeof t != "symbol" ? t + "" : t, e);
import { a as l } from "./constants-VtpJoDW0.js";
const { DocumentSheetV2: c, HandlebarsApplicationMixin: p } = foundry.applications.api;
class a extends p(c) {
  /**
  ...
  async _prepareContext(t, e) {
    ...
    return console.log("Preparing context", t, o), console.log("Parts:", TestApp.PARTS), o;
  }
  /**
...
n(a, "DEFAULT_OPTIONS", {
  ...
  form: {
    template: `${l}/static/templates/TestApp.hbs`
  }
});
export {
  a as default
};
//# sourceMappingURL=DreBaseSheet.js.map
